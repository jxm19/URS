...
export class UploadNoteComponent implements OnInit {
  ...
  private coursesApiUrl = 'http://127.0.0.1:8008/api/dashboard-instructor/courses'; // Updated API URL
  ...
  confirmAttendance() {
    ...
    this.http.post('http://127.0.0.1:8008/api/dashboard-instructor/exam-details', examDetailData, { headers }).subscribe({
      next: (response) => {
