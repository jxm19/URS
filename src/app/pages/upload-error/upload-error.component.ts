...
import { ThickuploadsucComponent } from '../../layout/thickuploadsuc/thickuploadsuc.component';

@Component({
  selector: 'app-upload-error',
  imports: [CommonModule, FormsModule, ThickuploadsucComponent],
  templateUrl: './upload-error.component.html',
  styleUrl: './upload-error.component.css'
})
